...
ActiveRecord::Schema.define(version: 2021_05_27_013011) do
  ...
  create_table "albums_photos", id: false, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "album_id"
    t.bigint "photo_id"
